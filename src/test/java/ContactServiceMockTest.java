...
public class ContactServiceMockTest extends EasyMockSupport {
    ...
    public void testAddContact() throws ContactDuplicateException {
        ...
        EasyMock.expect(contactDao.findByName("CeQueVousVoulez"))
                .andReturn(new Contact());
        // 2 - Fin d'enregistrement
        replayAll();
        // 3 - Test
        service.add("CeQueVousVoulez");
    }
    ...
    public void testDeleteContact() throws ContactNotFound {
        ...
        EasyMock.expect(contactDao.findByName("ContactInexistant"))
                .andReturn(null);
        contactDao.delete(contact);
        replayAll();
        service.delete("ContactInexistant");
    }
}
